...
def generateInitials(nautilus: nautilus.app.Nautilus, debug: bool) -> None:
	...
	properties = ""
	for k in nautilus.project.properties.keys():
		properties += f'\tgame.setProperty("{k}", "{nautilus.project.properties[k]}")\n'
...
{properties}
	...
	game.player = game.dictionary.nouns("{nautilus.project.player}")[0]
